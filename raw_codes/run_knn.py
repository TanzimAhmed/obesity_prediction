...
# Feature Selection
selection = SelectPercentile(percentile=75)
...
show_pr_curve(knn, x_test_compressed, y_test)
show_roc_curve(y_train, y_train_predict, label='KNN (Training Set)')
show_roc_curve(y_test, y_test_predict, label='KNN (Test Set)')
